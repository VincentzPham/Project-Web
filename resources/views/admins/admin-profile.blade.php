            ...
            <!-- Table Start -->
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4"><a href="{{url('admins/admin-add')}}" class="btn btn-outline-primary">Add Admin</a></h6>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($data as $adm)
                                        <tr>
                                            <th scope="row">{{$adm->adminID}}</th>
                                            <td>{{$adm->adminFullName}}</td>
                                            <td><img src="../admins/img/{{$adm->adminPhoto}}" alt="No image" height="40px" width="40px" title="{{$adm->adminPhoto}}"></td>

                                        <td>
                                            <a href="{{ url('admin-delete/'. $adm->adminID) }}"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                        @endforeach
                                    </tbody>
