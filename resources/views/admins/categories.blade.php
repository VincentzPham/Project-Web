            ...
            <!-- Table Start -->
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4"><a href="{{url('admins/category-add')}}" class="btn btn-outline-primary">Add Category</a></h6>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('category-edit/'. $prod->categoryID) }}"><i class="fa fa-edit"></i></a>
                                                <a href="{{ url('category-delete/'. $prod->categoryID) }}"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
