            ...
            <!-- Table Start -->
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4"><a href="{{url('admins/product-add')}}" class="btn btn-outline-primary">Add Product</a></h6>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="../customers/product/{{$prod->productImage}}" alt="No image" height="140px" width="100px" title="{{$prod->productImage}}">
                                            </td>
                                            <td>{{$prod->categoryName}}</td>
                                            <td>
                                                <a href="{{ url('admins/product-edit/'. $prod->productID) }}"><i class="fa fa-edit"></i></a>
                                                <a onclick="return confirm('Do you want to delete this Product?')" href="{{ url('product-delete/'. $prod->productID) }}"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
