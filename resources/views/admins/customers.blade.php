        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{url('admins/customers')}}" class="nav-item nav-link active"><i class="fa fa-file me-2"></i>Customer</a>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">{{$cust->customerEmail}}</th>
                                            <td>{{$cust->customerName}}</td>
                                            <td>{{$cust->customerAddress}}</td>
                                            <td>{{$cust->customerPhone}}</td>
                                        <td>
                                            <a href="{{ url('customer-delete/'. $cust->customerEmail) }}"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
