        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{url('admins/admin-profile')}}" class="nav-item nav-link active"><i class="fa fa-file-alt me-2"></i>Admin</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="{{url('admins/admin-edit/'. Session::get('adminLogin'))}}" class="dropdown-item">Profile</a>
                        </div>
                    </div>
                </div>
            </nav>
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="adminID" value="{{$data->adminID}}" readonly>
                            <label for="floatingInput">Admin ID</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingPassword" name="adminFullName" value="{{$data->adminFullName}}">
                            <label for="floatingPassword">Name</label>
                        </div>
                        <div class="mb-3">
                            <label for="formFile" class="form-label">Choose your avatar</label>
                            <input class="form-control" type="file" id="formFile" name="adminPhoto">
                        </div>
                    </div>
                </div>
                <div class="md-3">
                    <button type="submit" class="btn btn-primary">Save</button>
                    <a href="{{ url('admins/index') }}" class="btn btn-danger">Back</a>
                </div>
                </form>
