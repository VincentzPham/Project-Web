            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="../img/{{Session::get('adminImage')}}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{url('admins/products')}}" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Product</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="../img/{{Session::get('adminImage')}}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="productID" value="{{$data->productID}}" readonly>
                            <label for="floatingInput">Product ID</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="productName" value="{{$data->productName}}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="productPrice" value="{{$data->productPrice}}">
                            <label for="floatingPassword">Price</label>
                        </div>
                        <div class="form-floating mb-3">
                            <textarea type="text" class="form-control" id="floatingInput" style="height: 150px;" name="productDetail" >{{$data->productDetail}}</textarea>
                            <label for="floatingTextarea">Detail</label>
                        </div>
                        <div class="mb-3">
                            <label for="formFile" class="form-label">Choose an image for your product</label>
                            <input class="form-control" type="file" id="formFile" name="productImage" value="{{old('productImage')}}">
                            @error('productImage')
                                    <div class="alert alert-danger" role="alert">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="floatingSelect" name="categoryID"
                                aria-label="Floating label select example" value="{{$data->categoryID}}">
