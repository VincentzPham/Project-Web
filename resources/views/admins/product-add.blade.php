            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="../admins/img/{{ Session::get('adminImage') }}" alt=""
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ url('admins/index') }}" class="nav-item nav-link"><i
                            class="fa fa-tachometer-alt me-2"></i>Dashboard</a>

                    <a href="{{ url('admins/products') }}" class="nav-item nav-link active"><i
                            class="fa fa-table me-2"></i>Product</a>
                    <a href="{{ url('admins/categories') }}" class="nav-item nav-link"><i
                            class="fa fa-th me-2"></i>Category</a>
                    <a href="{{ url('admins/customers') }}" class="nav-item nav-link"><i
                            class="fa fa-file me-2"></i>Customer</a>
                    <a href="{{ url('admins/admin-profile') }}" class="nav-item nav-link"><i
                            class="fa fa-file-alt me-2"></i>Admin</a>
    ...
    <div class="content">
        ...
        <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <div class="navbar-nav align-items-center ms-auto">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                        <img class="rounded-circle me-lg-2" src="../admins/img/{{ Session::get('adminImage') }}"
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" name="productID"
                                    placeholder="Enter product ID" value="{{ old('productID') }}">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword" name="productName"
                                    placeholder="Password" value="{{ old('productName') }}">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword" name="productPrice"
                                    placeholder="Password" value="{{ old('productPrice') }}">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" name="productDetail" id="floatingTextarea"
                                     style="height: 150px;">{{ old('productDetail') }}</textarea>
                                <label for="floatingTextarea">Product Detail</label>
                                @error('productDetail')
                                    <div class="alert alert-danger" role="alert">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                <label for="formFile" class="form-label">Choose an image for your product</label>
