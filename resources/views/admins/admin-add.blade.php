                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="adminID"
                                placeholder="Enter product ID">
                            <label for="floatingInput">Admin ID</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingPassword" name="adminPass"
                                placeholder="Password">
                            <label for="floatingPassword">Password</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingPassword" name="adminFullName"
                                placeholder="Password">
                            <label for="floatingPassword">Full Name</label>
                        </div> <br>
                        <div class="mb-3">
                            <label for="formFile" class="form-label" name="Admin Photo">Choose an avatar</label>
