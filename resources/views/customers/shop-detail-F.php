                    ...
                    <div class="col-lg-3">
                        <div class="header__logo">
                            <img src="../customers/product/logo.jpg" style="
                                ...
                                height: 50px;
                            ">
                            <link rel="stylesheet" href="{{asset('../customers/product/logo.jpg')}}"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            <tr>
                                ...
                                <td>
                                    <img src="../customers/img/{{$data->productImage}}" alt="No image" height="140px" width="100px" title="{{$data->productImage}}">
                                </td>
