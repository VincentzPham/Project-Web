            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="index"><img src="../customers/product/logo.jpg" alt="" style="
                            width: 119px;
                            height: 50px;
                        "></a>
                    </div>
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        ...
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="../customers/product/{{$product->productImage}}" alt="">
                                            </div>
                    ...
                    <div class="product__discount">
                        ...
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                @foreach ($data as $product)
                                <?php
                                $discount = $product->productPrice-($product->productPrice/5);
                                ?>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="../customers/product/{{$product->productImage}}"  >
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <h5><a href="{{ url('customers/shop-detail/'. $product->productName) }}">{{$product->productName}}</a></h5>
                                            <div class="product__item__price">${{$discount}} <span>${{$product->productPrice}}</span></div>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                            <div class="featured__item">
                                ...
                                <div class="featured__item__text">
                                    <span>{{$data->categoryName}}</span>
                                    <h6><a href="{{ url('customers/shop-detail/'. $product->productName) }}">{{$product->productName}}</a></h6>
