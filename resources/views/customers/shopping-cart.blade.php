...
<head>
    ...
    <title>UBook | Shopping Cart</title>
                            ...
                            <tbody>
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="img/cart/cart-1.jpg" alt="" height="300px" width="200px">
                                        <h5>Phantom Lady</h5>
                                    </td>
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="img/cart/cart-2.jpg" alt="" height="300px" width="200px">
                                        <h5>Homodeus</h5>
                                    </td>
                                    <td class="shoping__cart__price">
                                        $300
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="img/cart/cart-3.jpg" alt="" height="300px" width="200px">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        <h5>Cart Total</h5>
                        <ul>
                            <li>Subtotal <span>$1020</span></li>
                            <li>Total <span>$1020</span></li>
                        </ul>
