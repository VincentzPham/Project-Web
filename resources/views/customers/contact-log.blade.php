...
<head>
    ...
    <title>UBook | Contact Page</title>
...
<!-- Header Section End -->
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="contact-log">Contact</a></li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Phone</h4>
                        <p>+84 67+2 68+1 70-1 71-2 72-3</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Address</h4>
                        <p>Zone 3, Hoang Thuong, Thanh Ba, Phu Tho</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
    ...
    <div class="map">
        <iframe
            src="https://maps.google.com/maps?width=2048&amp;height=2048&amp;hl=en&amp;q=khu 3 hoàng thương thanh ba phú thọ&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ...
        <div class="map-inside">
            ...
            <div class="inside-widget">
                ...
                <ul>
                    ...
                    <li>Add: Khu 3. Hoàng Thương, Thanh Ba, Phú Thọ</li>
                </ul>
            </div>
        </div>
    </div>
