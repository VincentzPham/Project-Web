...
class AdminController extends Controller
{
    ...
    public function editAdmin($id)
    {
        ...
        return view('admins/admin-edit', compact('data'));
    }
    ...
    public function updateAdmin(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Admin profile have been updated!');
    }

    public function deleteAdmin($id)
    {
        Admin::where('adminID', '=', $id)->delete();
        return redirect()->back()->with('success', 'An admin has been deleted!');
    }
    ...
    {
        $data = Admin::get();
        return view('admins/admin-add',compact('data'));
    }
